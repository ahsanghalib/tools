...
function VKI_buildKeyboardInputs() {
  ...
  this.VKI_version = "1.11";
  this.VKI_target = this.VKI_visible = "";
  this.VKI_shift = this.VKI_capslock = this.VKI_alternate = this.VKI_dead = false;
  this.VKI_deadkeysOn = false;
  this.VKI_kt = "Urdu";  // Default keyboard layout
  this.VKI_range = false;
  this.VKI_keyCenter = 3;
  this.VKI_isIE = /*@cc_on!@*/false;
  this.VKI_isIE6 = /*@if(@_jscript_version == 5.6)!@end@*/false;
  this.VKI_isMoz = typeof window.sidebar != "undefined";
  ...
  this.VKI_layout.Urdu = [ // Urdu Keyboard
    [["\u0657", "\u064C "], ["1", "!", "\u0661"], ["2", "@", "\u0662"], ["3", "#", "\u0663"], ["4", "$", "\u0664"], ["5", "%", "\u0665"], ["6", "^", "\u0666"], ["7", "&", "\u0667"], ["8", "*", "\u0668"], ["9", "(", "\u0669"], ["0", ")", "\u0660"], ["-", "_"], ["=", "+"], ["Bksp", "Bksp"]],
    [["Tab", "Tab"], ["\u0642"], ["\u0648", "\u0624"], ["\u0639", "\u0651"], ["\u0631", "\u0691"], ["\u062A", "\u0679"], ["\u06D2", "\u0601"], ["\u0626", "\u0621"], ["\u06CC", "\u0670"], ["\u06C1", "\u06C3"], ["\u067E", "\u064F"], ["\u201C", "\u2018"], ["\u201D", "\u2019"], ["\u060E", "\u0603"]],
    [["Caps", "Caps"], ["\u0634", "\u0650"], ["\u0633", "\u064d"], ["\u064a", "\u005d"], ["\u0628", "\u005b"], ["\u0644", "\u0644"], ["\u0627", "\u0623"], ["\u062a", "\u0640"], ["\u0646", "\u060c"], ["\u0645", "\u002f"], ["\u0643", "\u003a"], ["\u0637", "\u0022"], ["Enter", "Enter"]],
    [["Shift", "Shift"], ["\u0632", "\u0630"], ["\u0634", "\u0698"], ["\u0686", "\u062B"], ["\u0637", "\u0638"], ["\u0628"], ["\u0646", "\u06BA"], ["\u0645", "\u064B"], ["\u060C", "\u064E"], ["\u06D4", "\u0650"], ["\u002F", "\u061F"], ["Shift", "Shift"]],
    [[" ", " ", " ", " "], ["Alt", "Alt"]]
  ];
        ...
        if ((ex.nodeName == "TEXTAREA" || ex.type == "text" || ex.type == "password") && ex.className.indexOf("keyboardInput") > -1) {
          if (!ex.id) {
		    ...
		    for (var i=0; i<_se.length; i++) {
		        if (_se[i].src && (_se[i].src.indexOf("keyboard.js") != -1) )
		        {			
			        _x=_se[i].src.indexOf("keyboard.js");
			        _sp=_se[i].src.substring(0,_x);		
		        }
	        }
    	
          var keybut = document.createElement('img');
              keybut.src = _sp+"keyboard.png";
  ...
  this.VKI_position = function() {
    if (self.VKI_visible != "") {
      ...
      self.VKI_keyboard.style.top = inputElemPos[1] - ((self.VKI_target.keyboardPosition == "fixed" && !VKI_isIE && !this.VKI_isMoz) ? VKI_scrollDist()[1] : 0) + self.VKI_target.offsetHeight + 3 + "px";
