...
(function($) {
	...
	$.fn.yamltabs.defaults = {
		...
		tabhead: "h4", // Tag or valid Query Selector of the Elements to Transform the Tabs-Navigation of (original are removed)
		tabbody: "code", // Tag or valid Query Selector of the Elements to be treated as the Tab Body
